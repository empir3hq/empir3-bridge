...
test('Agy parses the tab-separated catalog emitted by current Windows builds', () => {
  const parsed = parseAgyModelCatalog(`Fetching available models...
...
`);
  ...
  assert.doesNotMatch(JSON.stringify(parsed), /Fetching available models/i);
});

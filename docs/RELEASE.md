...
- macOS packages must be Developer ID-signed, submitted to Apple notarization,
  ...
  strategy from `docs/internal/SIGNING.md`. The manual **Signed macOS
...
Distribution-channel internals and the maintainer checklist live in
`docs/internal/CHANNELS.md` and `docs/internal/SIGNING.md`.

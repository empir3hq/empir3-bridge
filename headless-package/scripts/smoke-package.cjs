...
try {
  ...
  for (const required of ['install.sh', 'uninstall.sh', 'package-metadata.json', 'runtime/trust/update-public-key.json', 'runtime/src/headless-entry.js', 'runtime/src/headless-update.cjs', 'runtime/src/install-config.cjs']) {

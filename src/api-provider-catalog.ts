...
export const API_PROVIDERS: readonly ApiProviderDefinition[] = [
  ...
  {
    slug: 'zai', relaySlug: 'bridge-api-zai', name: 'z.ai (API credits)',
  ...
  {
    // A GLM Coding Plan subscription is served ONLY from the coding endpoint.
    // The pay-as-you-go row above points at /api/paas/v4, which bills the API
    // wallet instead — a subscriber who pastes a plan key there gets an auth
    // rejection or silently spends the wrong balance. Two rows, on purpose.
    slug: 'zai-coding', relaySlug: 'bridge-api-zai-coding', name: 'z.ai (GLM Coding Plan)',
    protocol: 'openai-compatible', apiBaseUrl: 'https://api.z.ai/api/coding/paas/v4', keyPlaceholder: '…',
    defaultModels: ['glm-5.3', 'glm-5.3-flash', 'glm-4.7', 'glm-4.6'],
  },
] as const;

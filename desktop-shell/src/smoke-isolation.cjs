...
function prepareSmokeEnvironmentDirectories({ isolationRoot, stateRoot, userData, env = process.env } = {}) {
  assertSmokeEnvironmentIsolation({ isolationRoot, stateRoot, userData, env });
